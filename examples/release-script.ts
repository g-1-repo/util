...
async function main() {
  ...
  // Import VersionBumpType from the correct location if not already imported
  // import type { VersionBumpType } from '../src/index.js'
  const versionType: import('../src/index.js').VersionBumpType = await select({
